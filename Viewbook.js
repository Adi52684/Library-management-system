...
const Viewbook = () => {
  return (
    <div className="vbcontainer">
            <div className="vbcard">
                 <img src={Book1} className='image2' alt="Book 1"/> 
                <ul>
            ...
            <div className="vbcard">
            <img src={Book2} className='image2' alt="Book 2"/>
                <ul>
            ...
            <div className="vbcard">
                <img src={Book4} className='image2' alt="Book 4"/>
            ...
            <div className="vbcard">
                <img src={Book5} className='image2' alt="Book 5"/>
            ...
            <div className="vbcard">
                <img src={Book6} className='image2' alt="Book 6"/>
            ...
            <div className="vbcard">
                <img src={Book7} className='image2' alt="Book 7"/>
            ...
            <div className="vbcard">
                <img src={Book8} className='image2' alt="Book 8"/>
            ...
            <div className="vbcard">
                <img src={Book9} className='image2' alt="Book 9"/>
