...
const Llogin = () => {
    ...
    return (
        <div>
        <Navbar />
        <div className="lldiagonal-container">
            <div className="llsignup-text">
                <p>Haven't Registered Yet? <a href="...">Register</a></p>
            </div>
            <div className="llogin-form-container">

                <form onSubmit={handleSubmit} className="llregistration-form">
                    <div className='llcontainer'>
                        <h1 className='lladmin'><center> Librarian Login</center></h1><br />
                        <div className="llform-group">
                            ...
                            {errors.email && <span className="llerror">{errors.email}</span>}
                        </div>
                        ...
                        <div className="llform-group">
                            ...
                            {errors.password && <span className="llerror">{errors.password}</span>}
                        </div>
                        ...
                        <center>
                            <input type="submit" value="Login" className="llogin-button" />
                        </center>
                    </div>
                </form>
            </div>
